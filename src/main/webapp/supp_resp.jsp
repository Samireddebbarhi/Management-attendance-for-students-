...
<h1>Supprimer Responsable</h1>
 <input type="text" name="cni" placeholder="CNI" required>
 <input type="submit"   name="act" value="supprimer"     placeholder="supprimer">
</form>
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">  <p align="right"><a href="Acceuil_resp.jsp">Retour a la page precedente-- </a>
</p>
