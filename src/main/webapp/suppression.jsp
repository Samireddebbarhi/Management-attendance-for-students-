...
<h1>Supprimer etudiant</h1>
 ...
 <input type="submit"   name="act" value="del"     placeholder="supprimer">
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">  <p align="right" ><a href="addStudent.jsp">Retour a la page precedente-- </a></p></p>
